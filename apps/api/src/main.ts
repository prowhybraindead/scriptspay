...
async function bootstrap() {
  ...
  app.setGlobalPrefix("api", {
    exclude: [
      { path: "checkout/create", method: RequestMethod.POST },
      { path: "checkout/:checkoutId", method: RequestMethod.GET },
      { path: "checkout/:checkoutId/status", method: RequestMethod.GET },
    ],
  });
  app.useGlobalPipes(
    new ValidationPipe({
